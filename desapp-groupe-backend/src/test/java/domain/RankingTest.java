...
//    private MonthlyRanking ranking;
//    private User user1;
//    private User user2;
//    private User user3;
//    private User user4;
...
//        list.add(user4);
//
//        this.ranking = new MonthlyRanking(4,2016,list);
//    }
//
//
//    @Test
//    public void test_getBestDriver() {
//        Assert.assertEquals(ranking.getBestDrivers().stream().findFirst().get(),user1);
//    }
//
//    @Test
//    public void test_getWorstDriver() {
//        Assert.assertEquals(ranking.getWorstDrivers().stream().findFirst().get(),user3);
//    }
//
//    @Test
//    public void test_getBestPassenger() {
//        Assert.assertEquals(ranking.getBestPassenger().stream().findFirst().get(),user4);
//    }
//
//    @Test
//    public void test_getWorstPassenger() {
//        Assert.assertEquals(ranking.getWorstPassenger().stream().findFirst().get(),user2);
//    }
//
//    @Test
//    public void test_getBestVehicles() {
//        Assert.assertEquals(ranking.getBestVehicles().stream().findFirst().get(),vehicle1);
//    }
//
//    @Test
//    public void test_getWorstVehicles() {
//        Assert.assertEquals(ranking.getWorstVehicles().stream().findFirst().get(),vehicle2);
//    }
